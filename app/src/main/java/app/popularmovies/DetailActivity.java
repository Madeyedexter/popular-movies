...
public class DetailActivity extends AppCompatActivity implements View.OnClickListener, VideoAdapter.VideoClickListener, SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        NestedScrollView nestedScrollView = (NestedScrollView) findViewById(R.id.sv_detail_activity);
        outState.putIntArray(getString(R.string.key_sv_position),new int[]{nestedScrollView.getScrollX(),nestedScrollView.getScrollY()});
    ...
    private void setScrollPosition(Bundle savedInstanceState) {
        if(savedInstanceState!=null && savedInstanceState.containsKey(getString(R.string.key_sv_position))){
            int[] svXY = savedInstanceState.getIntArray(getString(R.string.key_sv_position));
            findViewById(R.id.sv_detail_activity).scrollTo(svXY[0],svXY[1]);
        }
    }
